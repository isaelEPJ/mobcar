...
class FavoriteDrawer extends StatefulWidget {
  ...
  @override
  _FavoriteDrawerState createState() =>
      _FavoriteDrawerState(favoriteList, _removeFavorite);
}
        ...
        children: <Widget>[
          ...
          Expanded(
            child: ListView.builder(
                itemCount: favoriteList.length, itemBuilder: _buildFavoriteRow),
          ),
        ],
      ),
    );
            ...
            subtitle: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text(
                    '${favoriteList[index]["Modelo"]} - ${favoriteList[index]["AnoModelo"]}',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 12.0),
                  ),
                ),
                Text(
                  '${favoriteList[index]["Combustivel"]} - Mês Ref. ${favoriteList[index]["MesReferencia"]}',
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: 12.0),
                ),
                Text(
                  favoriteList[index]["Valor"],
                  textAlign: TextAlign.center,
